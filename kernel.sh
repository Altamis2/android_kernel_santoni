...
curl -s -X POST https://api.telegram.org/bot$BOT_API_KEY/sendMessage -d text="Stable Build Scheduled for $KERNELNAME Kernel (MIUI) " -d chat_id=$CHAT_ID
${MAKE} $DEFCONFIG ;
START=$(date +"%s");
